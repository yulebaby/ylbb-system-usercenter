<template>
	<div class="information">
		...
		<div class="pair">
			...
			<input class="phone input" type="text" placeholder="请填写手机电话" v-model='userMsg.phone=="null" ? "" : userMsg.phone' readonly/>
		</div>
		<div class="subMsg_title">员工信息</div>
		<div class="pair">
			<label class="label" for="">入职日期</label>
			<input class="date input" type="text" placeholder="请选择日期" v-model='userMsg.entryTime=="null" ? "" : userMsg.entryTime' readonly/>
		</div>
		<div class="pair">
		...
		<div class="pair">
			...
			<input class="bumen input" type="text" placeholder="请选择所属部门" v-model='userMsg.departmentCode=="null" ? "" : userMsg.departmentCode' readonly/>
		</div>
		<div class="pair">
			<label class="label" for="">职位</label>
			<input class="job input" type="text" placeholder="选择您的职位" v-model='userMsg.position=="null" ? "" : userMsg.position' readonly/>
		</div>
		<div class="btn_box">
...
<script>
	export default{
		...
		mounted(){
			...
			this.userMsg=eval('('+this.$route.params.per_msg+')');
